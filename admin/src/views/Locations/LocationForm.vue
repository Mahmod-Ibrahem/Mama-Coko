            ...
            <form v-else @submit.prevent="onSubmit">
                <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <!-- Location Image -->
                        <div>
                            <label class="block text-sm font-medium text-slate-700 mb-1.5">Location Image</label>
                            <div class="relative w-1/4">
                                <input type="file" id="location-image" class="hidden" accept="image/*"
                                    @change="e => handleFileChange(e.target.files[0])" />
                                <label for="location-image" class="flex flex-col items-center justify-center w-full h-80 
                                    ...
                                    <img v-if="imagePreview" :src="imagePreview" alt="Location Preview"
                                    ...
                                    <div v-else class="text-center p-6">
                                        ...
                                        <p class="mt-2 text-sm text-slate-500">Click to upload location image</p>
                                    </div>
                                </label>
                            </div>
    ...
    if (route.params.id) {
        ...
        store
            ...
            .then((response) => {
                loading.value = false;
                location.value = response.data;
                imagePreview.value = location.value.image_url;
            });
    }
});
</script>
