...
export function setGalleries(state, data) {
    state.galleries.data = data.data
    state.galleries.loading = false
    state.galleries.from = data.meta?.from
    state.galleries.to = data.meta?.to
    state.galleries.total = data.meta?.total
    state.galleries.per_page = data.meta?.per_page
    state.galleries.links = data.meta?.links
}
