...
Route::group([], function () {
    ...
    Route::get('/day-tours/{category}', [DayTourController::class, 'view'])->name('day-tours.view');
    Route::get('/day-tours/{category}/{tour}', [DayTourController::class, 'show'])
        ->name('day-tours.show');
    /* TourPackages Controller*/

    Route::get('/tour-packages', [TourPackageController::class, 'index'])->name('tour-packages.index');
    Route::get('/tour-packages/{category}', [TourPackageController::class, 'view'])->name('tour-packages.view');
    Route::get('/tour-packages/{category}/{tour}', [TourPackageController::class, 'show'])
